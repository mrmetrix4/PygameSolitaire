...
class Card:
    ...
    def __init__(self, card_dict, cards_sprite_sheet) -> None:
    ...
    @staticmethod
    def init_sprite(card_dict, cards_sprite_sheet) -> (pygame.Rect, pygame.Surface):
        ...
        card_surf.blit(cards_sprite_sheet, (0, 0), card_rect)
        color_key = card_surf.get_at((0, 0))
        card_surf.set_colorkey(color_key)
        return card_surf

    def draw(self, screen, **kwargs):
        screen.blit(self.card_surf, self.card_surf.get_rect(**kwargs))
